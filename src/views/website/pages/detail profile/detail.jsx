              ...
              <div className="RectangleWhiteLeft">
                <div className="personalProfile">
                  ...
                  <div className="profiledata">
                    <h3>{detail.name || 'Name:'}</h3>
                    <h2>{detail.job_desk || 'Job Desk:'}</h2>
                    <div className="domicilemap">
                      <img src={map} alt="mapdomicile" /> <p>{detail.domicile || 'Domicile:'}</p>
                    </div>
                    <p>{detail.workplace || 'Work Place'}</p>
